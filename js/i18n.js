...
const DICT = {
  en: {
    ...
    name: "Name", gender: "Gender", brother: "Brother", sister: "Sister", group: "Group", roles: "Roles",
    ...
    thisWeek: "This week", gaps: "Open assignments", conflicts: "Conflicts", fairness: "Workload",
  ...
  ta: {
    ...
    name: "பெயர்", gender: "பாலினம்", brother: "சகோதரர்", sister: "சகோதரி", group: "குழு", roles: "பொறுப்புகள்",
    ...
    thisWeek: "இந்த வாரம்", gaps: "நிரப்பப்படாதவை", conflicts: "முரண்பாடுகள்", fairness: "பணிச்சுமை",
